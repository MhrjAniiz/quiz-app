(function () {
  ...
  var display = {
    ...
    mainPage: function () {
      ...
      newEl +=
        '<ul><li><label><input type="radio" name="answers" id="input1" value="1"><span class="outer"><span class="inner"></span></span><div id="answerDisplay1"></div></label></li>';
      newEl +=
        '<li><label><input type="radio" name="answers" id="input2" value="2"><span class="outer"><span class="inner"></span></span><div id="answerDisplay2"></div></label></li>';
      newEl +=
        '<li><label><input type="radio" name="answers" id="input3" value="3"><span class="outer"><span class="inner"></span></span><div id="answerDisplay3"></div></label></li></ul>';
    ...
    resultPage: function () {
      this.getApp.innerHTML =
        '<h1 class="h3">You have ' +
        data.points +
        " question(s) answered correctly</h1>";
  ...
  var control = {
    init: function () {
      var start =
        document.getElementById("start") || document.getElementById("restart");
